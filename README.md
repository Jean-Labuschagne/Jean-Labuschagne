...
<div style="border:1px solid #e1e4e8;border-radius:8px;padding:16px;background:#fff;box-shadow:0 8px 24px rgba(3,102,214,0.06);">
  ...
  <p><strong>Files:</strong> <a href="Level 3 - Artificial Intelligence and Machine Learning/M06T05 – Capstone Project – Linear Regression in Action/Linear_Regression_Ames.ipynb">Linear_Regression_Ames.ipynb</a></p>
</div>
...
<div style="border:1px solid #e1e4e8;border-radius:8px;padding:16px;background:#fff;box-shadow:0 8px 24px rgba(3,102,214,0.06);">
  ...
  <p><strong>Files:</strong> <a href="Level 2 - Data Analytics and Database Systems for AI/M05T10 – Capstone Project – Data Analysis/Code Files/Capstone_Project_template.ipynb">Capstone_Project_template.ipynb</a> · <a href="Level 2 - Data Analytics and Database Systems for AI/M05T10 – Capstone Project – Data Analysis/Code Files/automobile.txt">automobile.txt</a></p>
</div>
...
<div style="display:flex;gap:12px;flex-wrap:wrap;">
  <div style="border:1px solid #e1e4e8;border-radius:8px;padding:12px;flex:1;min-width:260px;box-shadow:0 8px 20px rgba(3,102,214,0.05);">
    ...
    <p>Small multi-user CLI app demonstrating software fundamentals and clear code structure. <a href="Level 1 - Python Programming for AI/M03T10 – Capstone Project – Task Manager/">Open folder</a></p>
  </div>
  <div style="border:1px solid #e1e4e8;border-radius:8px;padding:12px;flex:1;min-width:260px;box-shadow:0 8px 20px rgba(3,102,214,0.05);">
    <h4>📊 Exploratory Data Analysis</h4>
    <p>Readable EDA notebooks that show insights and visual storytelling for business stakeholders. <a href="Level 2 - Data Analytics and Database Systems for AI/M05T08 – Exploratory Data Analysis/">Open folder</a></p>
  </div>
</div>
